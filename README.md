...
My dotfiles describe my entire computer. I'm using Ubuntu as my Linux distribution of choice. They contain most of the configuration of my applications (both on the command line and on the GUI), but also the setup and update process as scripts. As I'm mainly working in my shell, the most important configuration files are those for vim, tmux, and fish. But there are also a bunch of tiny helper scripts. I'm using [Solarized Light](https://ethanschoonover.com/solarized) as my color scheme and [Input](http://input.fontbureau.com) as my font. This is how my work environment looks like:
...
* Listening to music via [Spotify](https://www.spotify.com/de) - see [#80](https://github.com/moonglum/dotfiles/issues/80)
...
I like to play around with other languages like Rust as well. I even wrote my [own little language](https://halunke.jetzt) :smile:
